      ...
      <div className="mx-auto grid max-w-6xl items-center gap-14 px-5 py-16 md:grid-cols-2 md:py-24">
        <div>
          ...
          <p className="mt-5 max-w-lg text-lg leading-relaxed text-ink-500">
            KiasuJobs shows you one job at a time. Swipe right and your saved
            resume goes straight to the employer. Swipe left and you never see
            it again. Most people get through a week of job boards in about four
            minutes.
          </p>
