// Kept as literals so the landing page builds standalone, with no dependency
// on the app's source. If you change the app's formatting, update these too.
const SALARY = "S$8k – S$11k";
const LOCATION = "Hybrid · Tanjong Pagar, Singapore";

/** Static preview of the deck, mirroring what the app renders. */
        ...
        <div className="px-4 pb-5">
          ...
          <div className="rounded-3xl border border-black/5 bg-white p-4 shadow-lg">
            ...
            <p className="mt-2.5 text-[11px] leading-relaxed text-ink-500">
              Own the merchant app 12,000 hawker stalls use to take payments. We
              care about startup time, offline behaviour and gesture feel…
            </p>
